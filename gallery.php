    ...
    ?>
      ...
      foreach ($result as $key => $value) {
          ...
          if ($value[login] == $_SESSION[Username]) {
              echo "<a href='user/remove_img.php?img=$value[id]&page=$_GET[page]'><img src='images/DeleteRed.png' width='42' style='position:left;'></a>";
          }
          echo "<img src='$value[img]' style='width:415px;'>
          <br/>
          Posted By : <i>$value[login]
          <br/></i>Likes: $likes
          <a href='user/ft_like.php?img_id=$value[id]&page=$_GET[page]' style='float:left; margin-top: -20px;'><img src='images/Like.png' width='42' height='42'></a>
